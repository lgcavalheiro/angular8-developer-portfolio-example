...
export const about = {
  ...
  experience: `I'm a software developer with 4 years of experience in the areas of telecommunications and banking.
      So far, i've worked maintaining I.T systems, developing software and single page applications.`,
  experience2: `I have worked with companies such as BNDES and IBM Global Financing in the pursuit of better fulfilling their business needs,
...
export const curriculum = {
  work: [
    {
      ...
      description:
        "Worked in the Q&A team as a testing intern, also performed some Customer Care functions.",
      results: "More agile work regarding customer service.",
    },
    {
      name: "BNDES (2013 - 2015)",
      description:
        "Worked as an intern, programming jobs to be sent to the mainframe and eventualy, some VBA macros for automation purposes.",
      results:
        "My work with the VBA macros made the team's work considerably faster, certain tasks that usually took 1 or 2 days to be completed were now being done in a matter of hours.",
    },
    {
      name: "IBM Global Financing (2019 - Present)",
      description:
        "As a developer student, i worked in the development of an internal S.P.A used for keeping track of the bank's transactions with clients.",
      results:
        "Performed several refactoring tasks and introduced the team to some Clean Code principles that improved the project's overall performance and maintainability.",
    },
  ],
  degrees: [`Systems Development and Analysis (UNICARIOCA)`],
  skills: {
    web: [
  ...
  badges: [
    {
      src:
        "https://hermes.digitalinnovation.one/certificates/cover/5C840C5A.jpg",
      link: "https://certificates.digitalinnovation.one/5C840C5A",
    },
    {
      src:
        "https://api.accredible.com/v1/frontend/credential_website_embed_image/badge/15189782",
      link:
        "https://skillsoft.digitalbadges.skillsoft.com/8724b22d-cbdc-4785-a475-a4a3aea4be8b#gs.9kvrfk",
    },
    {
      src:
        "https://images.youracclaim.com/size/680x680/images/5ca7b236-6105-4154-ba22-c8ae12ec1d8c/Data%2BSci%2BFound%2BLevel%2B1%2B-%2BCC%2B-%2B2019.png",
      link:
        "https://www.youracclaim.com/badges/961793d4-9ec7-4823-a7c9-8a28648d52bf/public_url",
    },
    {
      src:
        "https://images.youracclaim.com/size/680x680/images/84ac9eff-b8a2-4683-846b-f59887a73801/Python%2B101%2BData%2BScience.png",
      link:
        "https://www.youracclaim.com/badges/4705af36-98ad-4c8c-bdde-77dd97551c03/public_url",
    },
    {
      src:
        "https://hermes.digitalinnovation.one/certificates/cover/94DBB041.jpg",
      link: "https://certificates.digitalinnovation.one/94DBB041",
    },
  ],
};
